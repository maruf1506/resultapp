...
public class fragment_home_dashboard extends Fragment {
    ...
    TextView net_amount_symbol, debit_amount_symbol, credit_amount_symbol;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if ((credit_amount - debit_amount) >= 0) {
            ...
            net_amount_symbol.setTextColor(getResources().getColor(R.color.sucess));
        } else {
            netbalance.setText("- " + Math.abs(credit_amount - debit_amount));
            netbalance.setTextColor(getResources().getColor(R.color.warning));
            net_amount_symbol.setTextColor(getResources().getColor(R.color.warning));
        }
